...
public class ForexController {
	...
	@Autowired
	@Qualifier("forexXmlJob")
	Job forexXmlJob;
	
	   @PostMapping("/forex-xml-batch")
	   public JobParameters  forexXmlJobProcessing(@RequestParam("file") MultipartFile req) throws IOException {
        ...
        req.transferTo(createfile);
	        ...
	        try {
	            jobExecution = jobLauncher.run(forexXmlJob, jobParameters);
