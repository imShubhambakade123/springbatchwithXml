...
//	
//	@Autowired
//	@Qualifier("securitiesXmlJob")
//	Job securitiesXmlJob;
//	
//	   @PostMapping("/securities-xml-batch")
//	   public JobParameters  securitiesXmlJobProcessing(@RequestParam("file") MultipartFile req) throws IOException {
//	    	
...
//	        try {
//	            jobExecution = jobLauncher.run(securitiesXmlJob, jobParameters);
