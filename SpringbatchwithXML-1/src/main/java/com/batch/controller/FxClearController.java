...
//@RestController
//@Slf4j
//public class FxClearController {
//
...
//	
//	@Autowired
//	@Qualifier("fxClearXmlJob")
//	Job fxClearXmlJob;
//	
//	   @PostMapping("/fxClear-xml-batch")
//	   public JobParameters  fxClearXmlJobProcessing(@RequestParam("file") MultipartFile req) throws IOException {
//	    	
...
//	        try {
//	            jobExecution = jobLauncher.run(fxClearXmlJob, jobParameters);
