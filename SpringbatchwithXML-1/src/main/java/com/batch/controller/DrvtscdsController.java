...
//@RestController
//@Slf4j
//public class DrvtscdsController {
//
...
//	
//	@Autowired
//	@Qualifier("drvtscdsXmlJob")
//	Job drvtscdsXmlJob;
//	
//	   @PostMapping("/drvtscds-xml-batch")
//	   public JobParameters  drvtscdsXmlJobProcessing(@RequestParam("file") MultipartFile req) throws IOException {
//	    	
...
//	        try {
//	            jobExecution = jobLauncher.run(drvtscdsXmlJob, jobParameters);
