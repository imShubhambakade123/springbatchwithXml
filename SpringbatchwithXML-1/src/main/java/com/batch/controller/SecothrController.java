...
//@RestController
//@Slf4j
//public class SecothrController {
//
...
//	
//	@Autowired
//	@Qualifier("secothrXmlJob")
//	Job secothrXmlJob;
//	
//	   @PostMapping("/secothr-xml-batch")
//	   public JobParameters  secothrXmlJobProcessing(@RequestParam("file") MultipartFile req) throws IOException {
//	    	
...
//	        try {
//	            jobExecution = jobLauncher.run(secothrXmlJob, jobParameters);
